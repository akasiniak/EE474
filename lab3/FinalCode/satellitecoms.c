//Haobo Zhang
//EE 474
//This implements the task satellitecomms. It takes in a void pointer and returns nothing. It is used to display the information on console. It also generates commands for vehicle communication and send it there through FIFO.
