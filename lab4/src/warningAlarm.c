...
void warningAlarm(void* WAD)
{
        ...
        *(data->fuelLow) = FALSE;
        ...
        {
                if((*(data->batteryLevelPtr)/3600000.0) > 50) //both are above 50%
                {
                        turnOffLED1();
                        LED1 = FALSE;
                        turnOffLED2();
                ...
                else if(((*(data->batteryLevelPtr)/3600000.0) && (*(data->batteryLevelPtr)/3600000.0) <= 50)) //fuel above 50%, battery between 10% and 50%
                {
                        turnOffLED1();
                        LED1 = FALSE;
                        turnOffLED3();
        ...
        {
                if((*(data->batteryLevelPtr)/3600000.0) > 50) //fuel level between 10% and 50%, battery above 50%
                {
                        turnOffLED2();
                        LED2 = FALSE;
                        turnOffLED3();
                ...
                else if(((*(data->batteryLevelPtr)/3600000.0) > 10) && (*(data->batteryLevelPtr)/3600000.0) <= 50) //both are between 10% and 50%
                {
                        turnOffLED3();
                        LED3 = FALSE;
                        if(call == 0) //turn on for 1 second
        ...
        {
                *(data->fuelLow) = TRUE;
                if((*(data->batteryLevelPtr)/3600000.0) > 50)
                {
                        turnOffLED3();
                        LED3 = FALSE;
                        turnOffLED2();
                ...
                else if(((*(data->batteryLevelPtr)/3600000.0) > 10) && (*(data->batteryLevelPtr)/3600000.0) <= 50)
                {
                        turnOffLED3();
